						...
						<div class="login_tab_con show">
                            <ul>
								...
								<li class="mobile_error">
                          		...
                          		<li class="sign_in"><a href="javascript:;" class="login_register blue_bg" id="login_register">确定</a></li>
                        	</ul>
                        </div>
					</div>
				</div>
