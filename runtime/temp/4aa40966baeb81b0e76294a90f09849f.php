...
<script type="text/javascript">
    ...
    $('.search_btn').click(function(){
        ...
        if(!keywords){
            ...
            location.href="<?php echo url("","",true,false);?>?classType_id=0&classSmallType_id=0&teaching_type=0&keywords="+keywords;
        }
    });
</script>
